...
const String title = "IntrinsicWidth Widget";

const String _Text0 =
"""   ### **描述**
> $title
- 一个widget，它将它的子widget的宽度调整其本身实际的宽度.
- 例如，当可用的宽度不受限制，并且您希望有一个子widget，否则它将尝试无限扩展以将自身大小改为更合理的宽度。
...
"""###  
> 代码参考 Demo01
-  如果没有IntrinsicHeight包裹的话 yellow，blue宽度会撑满全屏，这个控件因为效率问题建议少用
```
 new IntrinsicWidth(
      child: new Row(
...
class IntrinsicWidthWidget extends BasefulWidget {
